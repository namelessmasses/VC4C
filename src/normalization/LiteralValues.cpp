...
static const std::map<Literal, ImmediateSupplier> immediateMappings = {
    ...
    {toLiteral(0x4e6e0000, static_cast<float>(bit_cast<int32_t>(1.0f / 256.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(40))},
    {toLiteral(0x4e700000, static_cast<float>(bit_cast<int32_t>(1.0f / 128.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(41))},
    {toLiteral(0x4e720000, static_cast<float>(bit_cast<int32_t>(1.0f / 64.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(42))},
    {toLiteral(0x4e740000, static_cast<float>(bit_cast<int32_t>(1.0f / 32.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(43))},
    {toLiteral(0x4e760000, static_cast<float>(bit_cast<int32_t>(1.0f / 16.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(44))},
    {toLiteral(0x4e780000, static_cast<float>(bit_cast<int32_t>(1.0f / 8.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(45))},
    {toLiteral(0x4e7a0000, static_cast<float>(bit_cast<int32_t>(1.0f / 4.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(46))},
    {toLiteral(0x4e7c0000, static_cast<float>(bit_cast<int32_t>(1.0f / 2.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(47))},
    {toLiteral(0x4e7e0000, static_cast<float>(bit_cast<int32_t>(1.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(32))},
    {toLiteral(0x4e800000, static_cast<float>(bit_cast<int32_t>(2.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(33))},
    {toLiteral(0x4e810000, static_cast<float>(bit_cast<int32_t>(4.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(34))},
    {toLiteral(0x4e820000, static_cast<float>(bit_cast<int32_t>(8.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(35))},
    {toLiteral(0x4e830000, static_cast<float>(bit_cast<int32_t>(16.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(36))},
    {toLiteral(0x4e840000, static_cast<float>(bit_cast<int32_t>(32.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(37))},
    {toLiteral(0x4e850000, static_cast<float>(bit_cast<int32_t>(64.0f))),
        ImmediateSupplier(OP_ITOF, SmallImmediate(38))},
    {toLiteral(0x4e860000, static_cast<float>(bit_cast<int32_t>(128.0f))),
    ...
    {toLiteral(0x77000000, bit_cast<int32_t>(1.0f / 256.0f) + bit_cast<int32_t>(1.0f / 256.0f)),
    ...
    {toLiteral(0x79000000, bit_cast<int32_t>(1.0f / 64.0f) + bit_cast<int32_t>(1.0f / 64.0f)),
    ...
    {toLiteral(0x7b000000, bit_cast<int32_t>(1.0f / 16.0f) + bit_cast<int32_t>(1.0f / 16.0f)),
    ...
    {toLiteral(0x7d000000, bit_cast<int32_t>(1.0f / 4.0f) + bit_cast<int32_t>(1.0f / 4.0f)),
    ...
    {toLiteral(0x7f000000, bit_cast<int32_t>(1.0f) + bit_cast<int32_t>(1.0f)),
        ImmediateSupplier(OP_ADD, SmallImmediate(32))},
    {toLiteral(0x80000000u, bit_cast<uint32_t>(2.0f) + bit_cast<uint32_t>(2.0f)),
    ...
    {toLiteral(0x81000000u, bit_cast<uint32_t>(4.0f) + bit_cast<uint32_t>(4.0f)),
    ...
    {toLiteral(0x83000000, bit_cast<uint32_t>(16.0f) + bit_cast<uint32_t>(16.0f)),
    ...
    {toLiteral(0x85000000, bit_cast<uint32_t>(64.0f) + bit_cast<uint32_t>(64.0f)),
