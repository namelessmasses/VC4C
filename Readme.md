...
For recent C++17 compatibility adjustments (including `Optional::operator&` ambiguity and `std::is_literal_type` deprecation handling), see `doc/changelog-cxx17-compat.md`.
