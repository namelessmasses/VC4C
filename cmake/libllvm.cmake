...
if(LLVM_CONFIG_PATH)
	...
	if(LLVM_FOUND)
		...
		if(LLVM_SHARED_LIBRARY AND NOT LLVM_SHARED_LIBRARY MATCHES "^${LLVM_LIBRARY_DIRS}/")
			unset(LLVM_SHARED_LIBRARY CACHE)
			unset(LLVM_SHARED_LIBRARY)
		endif()
		find_library(LLVM_SHARED_LIBRARY NAMES LLVM libLLVM PATHS "${LLVM_LIBRARY_DIRS}" NO_DEFAULT_PATH)
		if(NOT LLVM_SHARED_LIBRARY)
